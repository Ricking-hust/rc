...
- (void)setSubViewsContent
{
    ...
    UIImage *posterImage = [UIImage imageNamed:self.activitymodel.acPoster];
    ...
    self.ac_title.text = self.activitymodel.acTitle;
    ...
    self.ac_time.text = self.activitymodel.acTime;
    ...
    self.ac_place.text = self.activitymodel.acPlace;
