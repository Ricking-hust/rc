...
#define COMFONTSIZE 14
#define NAMEFONTSIZE 9
#define PADDING  10
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        if (!_nameLab) {
            ...
            [_nameLab setFont:[UIFont systemFontOfSize:NAMEFONTSIZE]];
            [self.contentView addSubview:_nameLab];
        }
        
        if (!_commentLab) {
            _commentLab = [[UILabel alloc]init];
            [_commentLab setFont:[UIFont systemFontOfSize:COMFONTSIZE]];
        ...
        if (!_timeLab) {
            ...
            [_timeLab setFont:[UIFont systemFontOfSize:NAMEFONTSIZE]];
        ...
        if (!_praiseNum) {
            ...
            [_praiseNum setFont:[UIFont systemFontOfSize:COMFONTSIZE]];
...
-(void)layoutSubviews{
    ...
    CGSize commentLabSize = [self sizeWithText:self.commentLab.text maxSize:maxSize fontSize:COMFONTSIZE];
