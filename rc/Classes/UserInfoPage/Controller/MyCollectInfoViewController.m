...
@interface MyCollectInfoViewController ()

@end

@implementation MyCollectInfoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *cellIndentifier = @"MyCollect";//这里的cellID就是cell的xib对应的名称
    
    MyCollect *cell = (MyCollect *)[tableView dequeueReusableCellWithIdentifier:cellIndentifier];
