...
/**瀑布流的列数*/
static const CGFloat BDefaultColumnCount = 2;
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGFloat h = [self.delegate collectionView: (RCCollectionView*)self.collectionView waterflowLayout:self heightForItemAtIndexPath:indexPath itemWidth:w];
